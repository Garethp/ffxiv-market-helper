...
const ProfitCard = ({
  ...
  return (
    <li className={cardClasses}>
      <div className="profit-card-name">
        <ItemSummaryTooltip itemId={item.itemId} name={item.name} />
      </div>
      <div className="profit-card-badges">
      ...
      <dl className="profit-card-figures">
        <dt>Buy DC</dt>
        <dd>
          {pricing?.buy ? (
            <a
...
/**
 * Each item as a card of its own: its name heading it, then its badges, then each figure beside
 * what it is.
 */
